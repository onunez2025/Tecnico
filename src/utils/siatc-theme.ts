 ...
 * Single Source of Truth for EBM/Flow Platform
 * 
 * Replicación exacta del sistema de diseño de la aplicación base.
 */
...
export const SIATC_THEME = {
    ...
    PROFILE_LAYOUT: {
        ...
        CAMERA_BUTTON: "absolute bottom-1 right-1 p-3.5 bg-primary text-primary-foreground rounded-full shadow-lg hover:bg-primary/90 hover:scale-110 transition-all duration-200 ring-2 ring-card",
        ...
        INPUT_ACTIVE: "block w-full min-h-[44px] pl-10 pr-3 py-2.5 bg-card border border-cb-border rounded-cb-btn focus:border-primary focus:ring-4 focus:ring-primary/10 outline-none transition-all text-sm font-bold text-cb-text-primary",
    ...
    MOBILE: {
        ...
        DATE_CHIP_DOT: "w-1 h-1 rounded-full absolute bottom-1",
    },
};
