...
export const SIATC_THEME = {
    ...
    MOBILE: {
        ...
        DATE_CHIP_SCROLLER: "flex gap-1.5 overflow-x-auto -mx-1 px-1 custom-scrollbar",
        DATE_CHIP_BASE: "flex flex-col items-center justify-center shrink-0 w-11 h-12 rounded-xl border text-xs font-bold transition-all relative",
